...
link_config .vimrc "$HOME/.ideavimrc"
...
link_config agents/CLAUDE.md "$HOME/.claude/CLAUDE.md"
link_config agents/claude-agents "$HOME/.claude/agents"
...
link_config agents/CODEX.md "$HOME/.codex/instructions.md"
link_config agents/codex-agents "$HOME/.codex/agents"
link_config agents/rules "$HOME/.codex/rules"
link_config agents/skills "$HOME/.codex/skills"
